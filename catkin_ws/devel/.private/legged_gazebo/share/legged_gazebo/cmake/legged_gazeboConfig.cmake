...
if("TRUE" STREQUAL "TRUE")
  set(legged_gazebo_SOURCE_PREFIX /media/keaton/KEATON/11_Design/jet-hr2/catkin_ws/src/legged_gazebo)
  set(legged_gazebo_DEVEL_PREFIX /media/keaton/KEATON/11_Design/jet-hr2/catkin_ws/devel/.private/legged_gazebo)
  ...
  set(legged_gazebo_INSTALL_PREFIX /media/keaton/KEATON/11_Design/jet-hr2/catkin_ws/install)
...
if(NOT "/media/keaton/KEATON/11_Design/jet-hr2/catkin_ws/src/legged_gazebo/include " STREQUAL " ")
  set(legged_gazebo_INCLUDE_DIRS "")
  set(_include_dirs "/media/keaton/KEATON/11_Design/jet-hr2/catkin_ws/src/legged_gazebo/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'bridgedp <contact@mdmbot.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'legged_gazebo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/media/keaton/KEATON/11_Design/jet-hr2/catkin_ws/src/legged_gazebo/${idir}'.  ${_report}")
    endif()
    _list_append_unique(legged_gazebo_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "dm_bipedal_hw_sim")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /media/keaton/KEATON/11_Design/jet-hr2/catkin_ws/devel/.private/legged_gazebo/lib;/media/keaton/KEATON/11_Design/jet-hr2/catkin_ws/devel/lib;/home/keaton/ocs2_ws/devel/lib;/opt/ros/noetic/lib)
...
set(depends "roscpp;legged_common;gazebo_ros_control")
