...
{
  /* USER CODE BEGIN 11 */
	  if(*Len== RECEIVE_DATA_SIZE) //Verify the length of the packet //验证数据包的长度
		{   
			 // num1++;
			 ...
			 if(rev_data.rx[0] == FRAME_HEADER) //Verify the frame tail of the packet //验证数据包的帧尾
			 {
				  ...
				  {	
						...
						{//4310		  //左臂
							num2[rev_data.rx[1]]++;
						  dm4310_fbdata_test(&robot_body.arm_motor[4], rev_data.rx);
						}
//						else if(rev_data.rx[1]==11)
//						{num2[rev_data.rx[1]]++;
//						  dm4310_fbdata_test(&robot_body.arm_motor[1], rev_data.rx);	
//						}
//						else if(rev_data.rx[1]==12)
//						{num2[rev_data.rx[1]]++;
//						  dm3507_fbdata_test(&robot_body.arm_motor[2], rev_data.rx);	
//						}
//						else if(rev_data.rx[1]==13)
//						{	num2[rev_data.rx[1]]++;
//						  dm3507_fbdata_test(&robot_body.arm_motor[3], rev_data.rx);	
//						}
						else if(rev_data.rx[1]==11)
						{	num2[rev_data.rx[1]]++;   //右臂
						 dm4310_fbdata_test(&robot_body.arm_motor[0], rev_data.rx);
						}					
//					else if(rev_data.rx[1]==15)
//					{//4340	
//						num2[rev_data.rx[1]]++;
//						dm4310_fbdata_test(&robot_body.arm_motor[5], rev_data.rx);	
//					}
//					else if(rev_data.rx[1]==16)
//					{num2[rev_data.rx[1]]++;
//						dm3507_fbdata_test(&robot_body.arm_motor[6], rev_data.rx);	
//					}
//					else if(rev_data.rx[1]==17)
//					{	num2[rev_data.rx[1]]++;
//						dm3507_fbdata_test(&robot_body.arm_motor[7], rev_data.rx);	
//					}
						
						
//						//腰部
//						else if(rev_data.rx[1]==18)
//						{	num2[rev_data.rx[1]]++;
//						  dm6006_fbdata_test(&robot_body.loin_motor, rev_data.rx);	
//						}
